...
export const Header = () => {
  return (
    // <div>
         <nav className="app-header navbar navbar-expand bg-body"  style={{marginLeft:'250px', width:'1099px', height:'57px', borderBottomWidth:'1px'}}>
        {/* <!--begin::Container--> */}
        <div className="container-fluid">
          ...
          <ul className="navbar-nav">
            ...
            <li className="nav-item d-none d-md-block"><a href="#" class="nav-link">Home</a></li>
            <li className="nav-item d-none d-md-block"><a href="#" class="nav-link">Contact</a></li>
          </ul>
                  ...
                  <div className="d-flex">
                    ...
                    <div className="flex-grow-1">
                      <h3 className="dropdown-item-title">
                        Brad Diesel
                        <span className="float-end fs-7 text-danger"><i class="bi bi-star-fill"></i></span>
                      </h3>
